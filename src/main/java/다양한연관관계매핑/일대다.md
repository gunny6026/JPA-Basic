...
```
member 엔티티에 team 객체를 넣어 team에 대한 정보를 알려고한다.

근데, 그렇게 되면 연관관계의 주인이 member, team 둘 다가 되어버린다.

그래서 연관관계의 주인이 아니라 읽기 전용이라는 것을 hibernate에 알려주기 위해서

insertable = false, updatable = false 를 설정해주었다.


![image](https://user-images.githubusercontent.com/66653324/110717079-c25d8900-824b-11eb-8ceb-9851a7b09191.png)
